        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="space-y-4 text-white">
              <p>
                EURODOOR kompaniyasi sifatida biz har bir uyning xavfsizligini
                ta'minlash uchun eng zamonaviy texnologiyalar va yuqori sifatli
                materiallardan foydalanib eshiklar ishlab chiqaramiz.
              </p>
              <p>
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-white max-w-2xl mx-auto">
            Bizning barcha mahsulotlarimiz xalqaro standartlarga javob beradi va
